...
@Component({
  ...
  styleUrl: './profil-membre.component.css'
})
...
export class ProfilMembreComponent implements OnInit {
  ...
  displayedColumns: string[] = ['codeMembre','nom','prenom','nomMagasin','email',
                                'numeroTelephone','adressePhysique','compteFacebook','action1','action2','action3','action4'];
  totalElements: number = 0; 
  pageSizeOptions: number[] = [8,10, 15, 20, 40,100,200,300,400,500,1000,1500];
